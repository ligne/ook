...
'''.lstrip()
    ...
    assert reading.metadata._list_book_choices(results, author_ids=set([5144]), work_ids=set([3298883])) == '''
...
'''.lstrip()
    ...
    assert reading.metadata._list_book_choices(results, author_ids=set([5144]), work_ids=set()) == '''
